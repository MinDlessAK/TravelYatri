      ...
      <div class="">
        <ul>
          <li class="lg:space-x-20 space-x-6 text-xl lg:flex hidden">
            <a href="#" class="text-white hover:underline-offset-4 hover:underline hover:text-cyan-400">Home</a>
            <a href="demo/trips" class="text-white hover:underline hover:underline-offset-4 hover:text-cyan-400">Trips</a>
            <a href="#" class="text-white hover:underline hover:underline-offset-4 hover:text-cyan-400">Reviews</a>
          </li>
        </ul>
      </div>
