  ...
  return (
    ...
    <div class="flex  gap-20  flex-col lg:flex-row">
       ...
       <div class=" w-80 flex flex-col gap-3 p-1">
          <div class="grow">
            <ImgTravel1 class="w-full h-full cursor-pointer rounded-lg hover:scale-110 transition-all duration-300 ease-in-out " />
          </div>
          <div>
       ...
       <div class=" w-80 flex flex-col gap-3 p-1">
          <div class="grow hover:scale-110 transition-all duration-300 ease-in-out ">
       ...
       <div class=" w-80 flex flex-col gap-3 p-1">
          <div class="grow ">
          <ImgMountain  class="h-full cursor-pointer w-full rounded-lg hover:scale-110 transition-all duration-300 ease-in-out " alt="" />
          </div>
          <div>
    ...
    <div >
        <button  class="block px-6 py-3 rounded-full bg-gradient-to-r from-sky-600 to-cyan-400 text-center text-white hover:scale-110 transition-all duration-300 ease-in-out font-semibold">See All</button>
    </div>
   </div>
    </>
  )
